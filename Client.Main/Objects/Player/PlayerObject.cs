...
namespace Client.Main.Objects.Player
{
    ...
    public class PlayerObject : WalkerObject
    {
        ...
        ///
        /// <b><c>LinkParentAnimation = false</c> 不是錯的，是必要的</b> ——
        /// 身體部位共用角色的 60 根骨頭所以是 true，但武器有自己的 13 根骨頭，
        /// 不可能共用矩陣，只能掛在一根骨頭上跑自己的動畫。
        /// 少的是一道<b>閘門</b>：沒人限制那個動畫什麼時候該跑。
        ///
        /// 為什麼一直沒被發現：劍、杖、盾、錘的模型動作都只有 <b>1 幀</b>，
        /// 「自己跑動畫」等於沒跑。<b>弓是唯一自己帶動畫的武器</b>，
        /// 換上去那 7 格就一直循環 —— 站著不動也在拉弓射箭。
        ///
