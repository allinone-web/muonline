    ...
    public TelemetrySnapshot Build(MuGame game, long telemetryDroppedMessages)
    {
        ...
        return new TelemetrySnapshot
        {
            ...
            World = new WorldTelemetry
            {
                ...
                DedicatedStaticMapObjects = worldMetrics?.DedicatedStaticMapObjects ?? 0,
                DedicatedParticleSystems = worldMetrics?.DedicatedParticleSystems ?? 0,
                ParticleSprites = worldMetrics?.ParticleSprites ?? 0,
                ParticleBatchBegins = worldMetrics?.ParticleBatchBegins ?? 0,
                ParticleSystemsCulled = worldMetrics?.ParticleSystemsCulled ?? 0,
                InactiveParticleSystemsSkipped = worldMetrics?.InactiveParticleSystemsSkipped ?? 0,
                StaticMapUpdateSkips = worldMetrics?.StaticMapUpdateSkips ?? 0,
                DrawAfterSkips = worldMetrics?.DrawAfterSkips ?? 0,
            ...
            Animation = new AnimationTelemetry
            {
                ...
                StaticInstanceUploads = ModelObject.LastFrameStaticMapInstanceUploads,
                StaticInstanceUploadReuses = ModelObject.LastFrameStaticMapInstanceUploadReuses,
                StaticShadowObjects = ModelObject.LastFrameStaticMapShadowInstancedObjects,
                StaticShadowDrawCalls = ModelObject.LastFrameStaticMapShadowInstancedDrawCalls,
                StaticShadowUploads = ModelObject.LastFrameStaticMapShadowInstanceUploads,
                StaticShadowUploadReuses = ModelObject.LastFrameStaticMapShadowInstanceUploadReuses,
