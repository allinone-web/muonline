...
/// </list>
///
/// 這一半留在編輯器，因為它要反射 <c>Client.Main</c>；產出的 JSON 由 Core 的
/// <see cref="MonsterCatalog"/> 讀取。
/// </remarks>
public static class NpcCatalogBuilder
{
    ...
    {
        var designations = openMuRoot is null ? [] : ReadServerDesignations(openMuRoot);
