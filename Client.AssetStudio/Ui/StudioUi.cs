...
public sealed partial class StudioUi
{
    ...
    private bool _showCatalogGodot;
    ...
    public void Draw()
    {
        ...
        if (_showCatalogGodot)
            DrawCatalogGodotPanel();
    ...
    private void DrawMenuBar()
    {
        ...
        if (ImGui.BeginMenu("視窗"))
        {
            ...
            if (ImGui.MenuItem("綜合資源目錄 → Godot", string.Empty, ref _showCatalogGodot)
                && _showCatalogGodot)
            {
                LoadCatalogIndex();
            }
    ...
    private void PlaceWindow(string panel)
    {
        ...
        (float x, float y, float w, float h) = panel switch
        {
            ...
            "綜合目錄" => (origin.X + leftWidth + 70f, origin.Y + 50f, 720f, 700f),
